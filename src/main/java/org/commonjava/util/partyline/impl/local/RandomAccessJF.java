...
//    private final FileLock fileLock;
     ...
     */
    RandomAccessJF( final File target, final LocalLockOwner owner, boolean doOutput )
            throws IOException
    {
     ...
     */
    RandomAccessJF( final File target, final LocalLockOwner owner, final StreamCallbacks callbacks, boolean doOutput, ReentrantOperationLock opLock )
            throws IOException
    {
        this.owner = owner;
...
//                fileLock = channel.lock( 0L, Long.MAX_VALUE, true );
     ...
     *
     * @see FileTree#withOpLock(File, ReentrantOperation) for associated logic
     */
