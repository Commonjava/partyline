 ...
 * @author jdcasey
 */
public final class JoinableRandomFile
...
//    private final FileLock fileLock;
     ...
     */
    JoinableRandomFile( final File target, final LockOwner owner, boolean doOutput )
            throws IOException
    {
     ...
     */
    JoinableRandomFile( final File target, final LockOwner owner, final StreamCallbacks callbacks, boolean doOutput, FileOperationLock opLock )
            throws IOException
    {
        this.owner = owner;
...
//            }
        ...
        public void flush()
                throws IOException
        {
            synchronized ( JoinableRandomFile.this )
            {
                if ( closed )
                {
                    throw new IOException( "Cannot write to closed stream!" );
            ...
            synchronized ( JoinableRandomFile.this )
            {
                JoinableRandomFile.this.notifyAll();
            }
            ...
            extends InputStream
    {
                ...
                throws IOException
        {
            synchronized ( JoinableRandomFile.this )
            {
                ...
                {
                    if ( output == null || JoinableRandomFile.this.closed )
                    {
                    ...
                    try
                    {
                        JoinableRandomFile.this.wait( 100 );
                    }
